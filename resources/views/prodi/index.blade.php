...
@section('content')
    ...
    <div class="row">
        <div class="col-md-6">
            <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light"></span> Data Prodi</h4>
        ...
        <div class="col-md-6 text-end m-auto">
            <a href="{{ route('prodi.create') }}" class="btn btn-outline-primary float-end mb-1 btn-sm">Tambah Data</a>
        </div>
    </div>
    <div class="card p-4">
                ...
                <tbody class="table-border-bottom-0">
                    @foreach ($prodis as $item)
                        <tr>
                            ...
                            <td>
                                <a class="btn btn-xs btn-warning" href="{{ route('prodi.edit', $item->id) }}">Edit</a>
