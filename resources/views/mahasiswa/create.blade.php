            ...
            <div class="card-body">
                <form action="{{ route('mahasiswa.store') }}" method="POST" autocomplete="off">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text " name="id" id="id" class="form-control @error('id') is-invalid @enderror" value="{{ old('id') }}" autofocus required>
                        @error('id')
                    ...
                    <div class="mb-3">
                        ...
                        <input type="tel" name="no_telepon" id="no_telepon" class="form-control" value="{{ old('no_telepon') }}" required>
                    </div>
                    ...
                    <div class="mb-3">
                        <label for="password" class="form-label">Password</label><span class="text-danger" style="font-size: 15px;"><i> *tanggal lahir (cth: 05052002)</i>
                        <input type="password" name="password" id="password" maxlength="8" class="form-control @error('password') is-invalid @enderror" required>
                        @error('password')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
