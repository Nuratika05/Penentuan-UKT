...
<div class="row">
    <div class="col-md-6">
        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light"></span> Data Kriteria</h4>
    ...
    <div class="col-md-6 text-end m-auto">
        <a href="{{ route('kriteria.create') }}" class="btn btn-outline-primary float-end mb-1 btn-sm">Tambah Data</a>
    </div>
</div>
<div class="card p-4">
        ...
        <table class="datatable table py-3">
            ...
            <tbody class="table-border-bottom-0">
                ...
                <tr>
                    ...
                    <td>{{ $item->nama}}</td>
                    <td>
                        <a class="btn btn-sm btn-warning" href="{{ route('kriteria.edit', $item->id) }}">Edit</a>
