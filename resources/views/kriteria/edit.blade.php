...
@section('content')
<h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light"></span> Edit Data Kriteria</h4>
<div class="card">
    <div class="row">
        <div class="col-md-8">
            <div class="card-body">
                <form action="{{ route('kriteria.update', $kriteria->id) }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="nama" id="nama" class="form-control" value="{{ $kriteria->nama }}" autofocus required>
                    </div>
