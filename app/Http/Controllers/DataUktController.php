...
class DataUktController extends Controller
{
    ...
    public function store(Request $request)
    {
        $message = [
            ...
            'foto_daya_listrik.image' => 'Foto Bukti Pembayaran Listrik harus dalam format gambar',
            'foto_daya_listrik.mimes' => 'Foto Bukti Pembayaran Listrik format: JPG,JPEG,PNG',
            'foto_daya_listrik.required' => 'Foto Bukti Pembayaran Listrik tidak boleh kosong',
            'foto_daya_listrik.max' => 'Foto Bukti Pembayaran Listrik: Ukuran Maksimal 2 MB',
